...
- while deleting an element, if an element is present then find its location from map and simply exchage that element with the last element in list. Update the same for the map as well
